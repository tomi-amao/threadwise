...
import { Check, CaretCircleDoubleDown } from 'phosphor-react';
...
>(({ className, children, ...props }, ref) => (
  ...
  >
    ...
    <SelectPrimitive.Icon asChild>
      <CaretCircleDoubleDown size={16} className="opacity-50" />
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.ScrollUpButton
    ...
    {...props}
  >
    <CaretCircleDoubleDown size={16} className="rotate-180" />
  </SelectPrimitive.ScrollUpButton>
));
